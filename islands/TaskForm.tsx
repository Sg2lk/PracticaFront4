...
export default function TaskForm({
  ...
  const formStatus = useSignal<TaskStatus>(
    taskToEdit?.status || TaskStatus.PENDING
  );
  ...
  const handleSaveTask = async (e: Event) => {
    ...
    // Asegurarse de que formStatus tiene un valor válido.
    const status = formStatus.value || TaskStatus.PENDING; // Default value if undefined or null

    const taskData: CreateTaskRequest = {
      title: formTitle.value,
      description: formDescription.value || undefined,
      status: status, // Use the formStatus value
      ...
      <form onSubmit={handleSaveTask}>
        ...
        <div class="form-group">
          ...
          <select
            ...
            onChange={(e) =>
              formStatus.value = (e.target as HTMLSelectElement).value as TaskStatus}
            class="form-select"
          >
